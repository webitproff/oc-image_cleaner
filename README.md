...
├── language/
│   ├── ru-ru/tool/image_cleaner.php
│   ├── en-gb/tool/image_cleaner.php
│   └── uk-ua/tool/image_cleaner.php
└── view/
    └── template/
        └── tool/
            └── image_cleaner.twig  # Шаблон отображения интерфейса
```
...
* Либо можно использовать Git: `git clone https://github.com/webitproff/oc-image_cleaner.git`

### 2. Копирование файлов

* Скопируйте содержимое папки `upload/` из архива в корневую директорию вашего сайта, где установлен ocStore/OpenCart.
* Структура папок должна сохраняться, чтобы файлы контроллера, языка и шаблона оказались на своих местах.
